...
func (mv *OwOStatement) statementNode()       {}
func (mv *OwOStatement) TokenLiteral() string { return mv.Token.Literal }
...
func (ms *OwOStatement) String() string {
	var out bytes.Buffer
...
func (we *ForExpression) expressionNode() {}

// TokenLiteral prints the literal value of the token associated with this node
func (we *ForExpression) TokenLiteral() string { return we.Token.Literal }

// String returns a stringified version of the AST for debugging
func (we *ForExpression) String() string {
	var out bytes.Buffer
